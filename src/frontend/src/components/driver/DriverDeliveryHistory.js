        ...
        <div>

              {
                ...
                Object.keys(this.props.deliveredOrders).map(t =>{
                  return(    
                  [this.props.deliveredOrders[t]].map(order =>{
                    return(
                ...
                <div class="card" style={{width:'100%'}}>
                    ...
                    <div class='row'>
                    <div class='col'><h5 class="card-title">{t}</h5></div>
                    <div class='col'><h5 class="card-text">{order.rName}</h5></div>
                    <div class='col'><Button variant="outline-primary" onClick={this.handleShow.bind(this)}>View Details</Button></div>
                    </div>
