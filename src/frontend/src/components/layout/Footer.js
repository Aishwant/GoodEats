                ...
                <div className="container" style={{marginTop:'20px'}}>
                    <div className="row mb-3">
                        <div className="col-md-4  text-center">
                            <h4>GoodEats</h4>
                            <p>We are here to help you. Don't worry about going to a restaurant and ordering when we can bring it to your doorstep.</p>
                        </div>
                        <div className="col-md-4 text-center">
                            <h4>Team Members</h4>
                        ...
                        <div className="col-md-4  text-center" style={{marginTop:"4%", fontSize:"16px"}}>
