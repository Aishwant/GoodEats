    ...
    onChange = e => this.setState({ [e.target.name]: e.target.value });
      ...
      render() {
        ...
        if(this.state.Phone !== "" && 
           this.state.Address1 !== "" && 
           this.state.City !== "" ){
            orderButton = <button className="btn btn-sm btn-dark" onClick={this.props.placeOrder.bind(this, this.props.items, this.props.rName, this.props.user['Customer'])}>Place Order</button>
        }else{
