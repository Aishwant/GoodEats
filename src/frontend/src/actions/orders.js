...
export const placeOrder = (orderData, rName, userData) => (dispatch) => {
  ...
  const order = { [orderID] : {'rID':rID, 'rName':rName, 'owner_ID':owner_ID, 'uID':uID, 'total':total, 'user_info':userData, 'items':orderData}}
  console.log(order);
  axios
